				    ...
				    @endforeach
                            ...
                            <div class="table-responsive" style="font-size: 12px;" id="tableData">
                              <table class="table table-bordered table-striped table-highlight" >
                                  <tr>
                                        <td> 
                                        <h4> As at {{date("jS M, Y", strtotime($curdate))}}</h4>
                                      ...
                                      <!--///end of consider quarter
                                      ///Begin of consider previous year quarter-->
                                       <td>
                                           <h4>As at {{date("jS M, Y", strtotime($prevdate))}}</h4>
                                          <table class="table-responsive" ><thead>
                                                <tr bgcolor="#c7c7c7">
                                                	  <th>ASSETS</th><th >Amount</th>
                                                </tr>
                                            	...
                                            	@foreach($LongLiability2 as $data)
                                    				<tr>
                        ...
                        <div class="table-responsive" style="font-size: 12px;" id="tableData2">
                            ...
                            <table class="table table-bordered table-striped table-highlight" >
                                ...
                                <tr>
                                    <td>@if($PLWithinCurrentYearCurrentQtr[0]->tVal<0)({{  number_format(abs($PLWithinCurrentYearCurrentQtr[0]->tVal),2, '.', ',')}})  @else{{  number_format(abs($PLWithinCurrentYearCurrentQtr[0]->tVal),2, '.', ',')}} @endif</td>
                                    <td></td>
                                    <td> <b>@if($PL[0]->tVal<0)({{  number_format(abs($PL[0]->tVal),2, '.', ',')}})  @else{{  number_format(abs($PL[0]->tVal),2, '.', ',')}} @endif</b></td>
                                    
                                    <td>@if($PLWithinPrevYearCurrentQtr[0]->tVal<0)({{  number_format(abs($PLWithinPrevYearCurrentQtr[0]->tVal),2, '.', ',')}})  @else{{  number_format(abs($PLWithinPrevYearCurrentQtr[0]->tVal),2, '.', ',')}} @endif</td>
                                    <td></td>
                                    <td> <b>@if( $PL2[0]->tVal<0)({{  number_format(abs($PL2[0]->tVal),2, '.', ',')}})  @else{{  number_format(abs($PL2[0]->tVal),2, '.', ',')}} @endif</b></td>
                                </tr>
                            </table>
                        </div>
