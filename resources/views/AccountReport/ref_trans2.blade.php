                        ...
                        <div class="table-responsive" style="font-size: 12px;" id="tableData">
                            <table class="table table-bordered table-striped table-highlight" ><thead>
                		  	<tr bgcolor="#c7c7c7">
                        		...
                        		<td>{{  $data->accountName}}({{  $data->accountcode}})
                        		<a onclick="editfunc('{{$data->id}}','{{$data->accountid}}')" class="btn btn-success  glyphicon glyphicon-edit btn-xs"></a>&nbsp;
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">  
                <div class="form-group" style="margin: 0 10px;">
                      ...
                      <div class="col-sm-12">
			             <div class="form-group">
                        <label class="control-label"><h5>Account: </h5></label>
                        <select class="select_picker form-control" id="account" data-live-search="true" name="account" >
                            <option value="">--Select--</option>
