              ...
              @include('_partialView.nofication')
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label class="control-label">Inventory Stock</label>
		        ...
		        <tbody>
    		           ...
    		           <tr>
    		               ...
    		               <td>{{$list->remarks}} </td>
    		               <td>{{$list->refno}} </td>
    		               <td> <a onclick="ViewDetails('{{$list->transtype}}','{{$list->refno}}')" class="btn btn-success">View</a></td>
    		            </tr>
    		            @endforeach
