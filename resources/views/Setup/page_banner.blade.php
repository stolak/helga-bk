    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row">
                    <div class="col">
                        <h3 class="page-title">Page Banner Setup</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/">Home</a></li>
                            <li class="breadcrumb-item active">Page Banner Setup</li>
                        </ul>
                    </div>
                    <div class="col-auto">
                        <a href="{{ url('page-banner-setup') }}" class="btn btn-sm btn-secondary">New</a>
                    </div>
                </div>
            </div>
            <!-- /Page Header -->
                            ...
                            <form method="post" enctype="multipart/form-data" name="bannerForm" id="bannerForm">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="eyebrow" class="form-control"
                                        value="{{ old('eyebrow', $edit->eyebrow ?? '') }}" autocomplete="off"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="subtitle" class="form-control"
                                        value="{{ old('subtitle', $edit->subtitle ?? '') }}" autocomplete="off">
                                </div>

                                <div class="form-group">
                                    <label>Text Color</label>
                                    <input type="text" name="textColor" class="form-control"
                                        value="{{ old('textColor', $edit->textColor ?? '') }}" autocomplete="off"
                                ...
                                @if ($edit && $edit->image)
                                    <div class="form-group">
                                        ...
                                        <div class="border rounded p-2">
                                            <img src="{{ $edit->image }}" alt="banner image" class="img-fluid"
                                    ...
                                    <tbody>
                                        @forelse ($banners as $b)
                                            <tr>
                                                <td>{{ $b->id }}</td>
                                                <td>{{ $b->title }}</td>
                                                <td class="text-truncate" style="max-width: 160px;">{{ $b->eyebrow }}</td>
                                                <td class="text-truncate" style="max-width: 120px;">{{ $b->textColor }}</td>
                                                <td>
                                                ...
                                                <td class="text-right">
                                                    <a class="btn btn-sm btn-info"
                                                        href="{{ url('page-banner-setup?edit=' . $b->id) }}">
                                                        Edit
                                                    </a>
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="7" class="text-center text-muted">No banners yet.</td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                                </table>
