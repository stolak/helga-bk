                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <option value="{{ $list->warehouseid }}" {{ (old('warehouse') == $list->id ||($warehouse) == $list->warehouse  ) ? 'selected':'' }}>{{ $list->warehouse }}</option>
                                    @endforeach
                				</select>
                                </div>
                            </div>
            ...
            <!--<div class="table-responsive" style="font-size: 11px; padding:10px; ">-->
		        ...
		        <tbody>
		          ...
		          @endphp
		               ...
		               <td> <div id="formatdiv" ><select id="sformat" name="sformat" style="width:100px;" class="form-control" onchange="DoAfterFormat()" >
                				<option value="">-Select-</option>
                				    @foreach($SalesFormat as $list)
