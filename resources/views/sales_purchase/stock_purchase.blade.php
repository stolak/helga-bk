...
@section('pageHead')
    <div id="page-head">
        <div id="page-title">
            <h1 class="page-header text-overflow">Purchase</h1>
        </div>
        <ol class="breadcrumb">
            <li><a href="/"><i class="demo-pli-home"></i></a></li>
            <li><a href="#">Stock Purchase</a></li>
        </ol>
    </div>
@endsection
@section('content')
                    ...
                    <div class="panel-body">
                        <div class="row">
                         ...
                         <div class="row">
                            ...
                            <div class="col-sm-2">
                                <div class="form-group">
                                    <label class="control-label">Purchase format</label>
                                    <div id="formatdiv" ><select id="pformat" name="pformat"  class="form-control" onchange="DoOnselectFormat()" >
                				<option value="">-Select-</option>
                				    @foreach($PurchaseFormat as $list)
                            ...
                            <div class="col-sm-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"  id="spr" name="spr" value="{{number_format(0,2, '.', ',')}}"   style="text-align: right; " onblur='DoAfterFormat()'>
                                </div>
                            </div>
                            <div class="col-sm-2">
                                <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <div class="form-group">
                                   ...
                                   <input type="text" class="form-control"  id="gross" value="{{number_format(0,2, '.', ',')}}"  readonly style="text-align: right;">
                                </div>
                            </div>
                            <div class="col-sm-2">
                                <div class="form-group">
                                   ...
                                   <input type="date" name="expdate" value="{{$expdate}}"   class="form-control" >
                                </div>
                            </div>
                             <div class="col-sm-2">
                                <div class="form-group">
                                    <label class="control-label"> <br><br></label>
                                    <input type="hidden" class="form-control" id="subt" value="{{number_format(0,2, '.', ',')}}"  readonly style="text-align: right;width:100px; ">
                                    <input type="hidden" class="form-control"  id="disc" value="0"   style="text-align: right;width:50px; " readonly>
		        ...
		        <tbody>
		          ...
		          @endphp
    		           ...
    		           <tr>
    		               <td>{{$i++}} </td>
    		               <td>{{$list->item}} </td>
    		               <td style="text-align:right">{{number_format($list->formatprice,2, '.', ',')}}/{{$list->format}} </td>
		                ...
		                <tr>
		                    ...
		                    <td ><label class="control-label">Transaction date</label>
   ...
   function DoOnselectFormat()
    {
        ...
        var id=document.getElementById('pformat').value;
