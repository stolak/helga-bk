...
@section('content')
    ...
    <div id="page-content">
		...
		@if (count($errors) > 0)
            ...
            @if($SelectItemdetails)
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"  value="{{$SelectItemdetails->vat}}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <div class="text-right">
                                        ...
                                        @endphp 
                                        <button class="btn btn-success" type="button" onclick="editEventoryfunc('{{$st->id}}','{{$st->catid}}','{{$st->brandid}}','{{$st->item_description}}','{{$st->minsku}}','{{$st->vat}}','{{$st->has_color}}','{{$st->has_size}}','{{$st->has_serialno}}')"><span class="glyphicon glyphicon-pencil"></span>edit</button>
                                    </div>
                                </div>
                            </div> 
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                      <h5 class="form-group">Purchase Format</h5>
                            ...
                            <table id="mytable" class="table table-bordered table-striped table-highlight">
                		        <thead>
                		          <tr bgcolor="#c7c7c7">
                		            <th>S/N</th>
                		            <th>Format</th>
                		            <th>{{$SelectItemdetails->format}} Quantity </th>
                		            <th>price</th>
                		            <th></th>
                		          </tr>
                		        </thead>
                		          ...
                		          @php $i=1; @endphp
                		            @foreach($PurchaseFormat as $list)
                		               <tr>
                    		               ...
                    		               <td>{{$list->price}} </td>
                    		               <td>
                        		               <a onclick="editPfunc('{{$list->id}}','{{$list->formatid}}','{{$list->minskuqty}}','{{$list->price}}')" class="btn btn-success  glyphicon glyphicon-edit btn-xs"></a>&nbsp;
                		        ...
                		        <tbody>
                		          ...
                		          @endphp
                		            @foreach($SalesFormat as $list)
                		               ...
                		               <td>{{$list->price}} </td>
                		               <td>
                		               <a onclick="editSfunc('{{$list->id}}','{{$list->formatid}}','{{$list->minskuqty}}','{{$list->price}}')" class="btn btn-success  glyphicon glyphicon-edit btn-xs"></a>&nbsp;
    ...
    <div id="editModal" class="modal fade" >
                ...
                <div class="form-group" style="margin: 0 10px;">
                      ...
                      <div class="col-sm-12">
			             <div class="form-group">
                            ...
                            <?php if($pqty=='') $pqty= old('pqty'); ?>
                            <input type="text" class="form-control"  value="{{$pqty}}" required name="pqty">
                        </div>
                      </div>
                      <div class="col-sm-12">
			             <div class="form-group">
            ...
            <div class="modal-body">  
                <div class="form-group" style="margin: 0 10px;">
                      ...
                      <div class="col-sm-12">
			             <div class="form-group">
                            <label class="control-label">@if($SelectItemdetails){{$SelectItemdetails->format}}  Quantity @endif</label>
                            <?php if($pqty=='') $fqty= old('sqty'); ?>
                            <input type="text" class="form-control"  value="{{$sqty}}" required name="sqty">
                        </div>
                      </div>
                      <div class="col-sm-12">
			             <div class="form-group">
        ...
        <div class="modal-dialog box box-default" role="document" style="color:black;">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Add New Meaturing</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            ...
            <div class="modal-body">  
                <div class="form-group" style="margin: 0 10px;">
                      ...
                      <div class="col-sm-12">
			             <div class="form-group">
                            <label class="control-label">@if($SelectItemdetails){{$SelectItemdetails->format}}  Quantity @endif</label>
                            <input type="text" class="form-control"   required name="qty" id="suqty">
                        </div>
                      </div>
                      <div class="col-sm-12">
			             <div class="form-group">
            ...
            <div class="modal-body">  
                <div class="form-group" style="margin: 0 10px;">
                      ...
                      <div class="col-sm-12">
			             <div class="form-group">
                            <label class="control-label">@if($SelectItemdetails){{$SelectItemdetails->format}}  Quantity @endif</label>
                            <input type="text" class="form-control"   required name="qty" id="puqty">
                        </div>
                      </div>
                      <div class="col-sm-12">
			             <div class="form-group">
