...
@section('pageHead')
    <div id="page-head">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#">Product Measurement Setup</a></li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <?php if($format=='') $format= old('format'); ?>
                                    <input type="text" class="form-control"  value="{{$format}}" required name="format">
                                </div>
                            </div>
		        ...
		        <tbody>
		          ...
		          @endphp
		            ...
		            @foreach($MFormat as $list)
		               ...
		               <td>{{ $list->format}} </td>
		               <td>
		               <a onclick="editfunc('{{$list->id}}','{{$list->format}}')" class="btn btn-success  glyphicon glyphicon-edit btn-xs"></a>&nbsp;
        ...
        <div class="modal-dialog box box-default" role="document" style="color:black;font-size:24px;">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Edit Measurement Format</h4>
            ...
            <div class="modal-body">  
                <div class="form-group" style="margin: 0 10px;">
                      ...
                      <div class="col-sm-12">
			             <div class="form-group">
                      <label class="control-label"><h5>Foramt: </h5></label>
...
<script>
    ...
    function editfunc(id,cat)
    {
        ...
        document.getElementById('format').value = cat;
