...
@section('pageHead')
    <div id="page-head">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#">Product Category Setup</a></li>
		        ...
		        <tbody>
		          ...
		          @endphp
		            ...
		            @foreach($CategoryList as $list)
		               ...
		               <td>{{ $list->category}} </td>
		               <td>
		               <a onclick="editfunc('{{$list->id}}','{{$list->category}}')" class="btn btn-success  glyphicon glyphicon-edit btn-xs"></a>&nbsp;
        ...
        <div class="modal-dialog box box-default" role="document" style="color:black;font-size:24px;">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Edit Product Category Record</h4>
