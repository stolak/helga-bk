...
@section('pageHead')
    <div id="page-head">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#">Manufacturer Setup</a></li>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <?php if($manufacturer=='') $manufacturer= old('manufacturer'); ?>
                                    <input type="text" class="form-control"  value="{{$manufacturer}}" required name="manufacturer">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
...
<div class="table-responsive" style="font-size: 11px; padding:10px;">
		        ...
		        <tbody>
		          ...
		          @endphp
		            ...
		            @foreach($Manufacture as $list)
		               ...
		               <td>{{ $list->phoneno }}</td>
		               <td>
		               <a onclick="editfunc('{{$list->id}}','{{$list->manufacturer}}','{{$list->address}}','{{$list->phoneno}}')" class="btn btn-success  glyphicon glyphicon-edit btn-xs"></a>&nbsp;
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">  
                <div class="form-group" style="margin: 0 10px;">
                      ...
                      <input type="text" class="form-control" id="manu" name="manufacturer">
                        </div>
                      </div>
                      <div class="col-sm-12">
			             <div class="form-group">
    ...
    <div id="deleteModal" class="modal fade" >
        <div class="modal-dialog box box-default" role="document" style="color:black;font-size:24px;">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Delete Manufacturer Record</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
...
<script>
    ...
    function editfunc(id,manu,address,phoneno)
    {
