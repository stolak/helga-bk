...
@section('pageHead')
    <div id="page-head">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#">Asset Type Setup</a></li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <?php if($type=='') $brand= old('type'); ?>
                                    <input type="text" class="form-control"  value="{{$type}}" required name="type">
                                </div>
                            </div>
		        ...
		        <tbody>
		          ...
		          @endphp
		            ...
		            @foreach($AssetList as $list)
		               ...
		               <td>
		               <a onclick="editfunc('{{$list->id}}','{{$list->asset_category}}','{{$list->assettype}}')" class="btn btn-success  glyphicon glyphicon-edit btn-xs"></a>&nbsp;
