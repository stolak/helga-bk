                ...
                {{ csrf_field() }}
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label class="control-label">New Asset</label>
                                    <?php if($asset=='') $brand= old('asset'); ?>
                                    <input type="text" class="form-control"  value="{{$asset}}" required name="asset">
                                </div>
                            </div>
		        ...
		        <tbody>
		          ...
		          @endphp
		            ...
		            @foreach($AssetList as $list)
		               ...
		               <td>{{ $list->Catgory}} </td>
		               <td>{{ $list->Type}} </td>
		               <td>{{ $list->asset_description}}</td>
		               <td>
		               <a onclick="editfunc('{{$list->id}}','{{$list->categoryId}}','{{$list->typeID}}','{{$list->asset_description}}')" class="btn btn-success  glyphicon glyphicon-edit btn-xs"></a>&nbsp;
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">  
                <div class="form-group" style="margin: 0 10px;">
                      ...
                      <div class="col-sm-12">
			             <div class="form-group">
                      <label class="control-label"><h5>Asset Category: </h5></label>
                      <select  class="form-control" id="manu"name="category" >
                                     <option value="">--Select--</option>
                                          @foreach($AssetCategory as $list)
                      ...
                      <div class="col-sm-12">
			             <div class="form-group">
                      <label class="control-label"><h5>Asset Type: </h5></label>
                      <input type="text" class="form-control" id="brand" name="type">
                        </div>
                      </div>
                      </div>
            </div>
