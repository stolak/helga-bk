...
<head>
    ...
    <!-- check button customised bootstrap-toggle-->
    <link href="https://gitcdn.github.io/bootstrap-toggle/2.2.2/css/bootstrap-toggle.min.css" rel="stylesheet">
    <script src="https://gitcdn.github.io/bootstrap-toggle/2.2.2/js/bootstrap-toggle.min.js"></script>
<!-- end check button customised bootstrap-toggle-->
...
<div id="container" class="effect aside-float aside-bright mainnav-lg">
    ...
    <!--NAVBAR-->
    <!--===================================================-->
    <header id="navbar" class="hidden-print" style="background:  #a26153;">
        <div id="navbar-container" class="boxed" style="background: #a26153;">

            <!--Brand logo & name-->
            <!--================================-->
            <div class="navbar-header" style="background: #a26153;">
                <a href="{{url('/')}}" class="navbar-brand" style="background:  #a26153;">
                    <!--<img src="img/logo.png" alt="Nifty Logo" class="brand-icon">-->
                    <div class="brand-title">
                        <span class="brand-text text-center">BKS</span>
                    </div>
                </a>
            </div>
...
@php $appinfo=DB::table('tblcompanyinfo')->first(); @endphp
        <div class="hide-fixed pull-right pad-rgt hidden-print">
            All rights Reserve - <strong>{{$appinfo->company_name?? ''}}</strong>
        </div>
        <p class="pad-lft hidden-print">&#0169; 2022 Your Company</p>
